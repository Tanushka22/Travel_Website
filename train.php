<?php
	...
	if(isset($_POST['submit'])){
		...
		$sql=$conn->prepare("Insert Into train (country_name,Email,Source,Destination,Date,Time,NumPpl)
...
<html>
	...
	<body class="is-preload" style="background-color:#002631;">
						...
						<!-- One -->
							<section id="one">
								<div class="inner">
									...
									<div class="row">
										<div class="col-md-6">
											<img src="images/train1.jpg" class="img-responsive" alt="">
										</div>
									...
									<section class="split">
										<section>
											<div class="contact-method">
												...
												<h3>Booking terms</h3>
												<span>The Railway Administration reserves seats, berths, compartments, or carriage in accordance with the rules and conditions published in the Coaching Tariff. A passenger seeking reservation of berth or seats should purchase tickets from the Railway Reservation Offices/Authorised Travel Agency only.
												...
												An individual can book only up to six passengers on one requisition form provided all passengers are for the same destination and for the same train.</span>
											</div>
										</section>
									</section>
								</div>
