<?php
	...
	if(isset($_POST['submit'])){
		...
		$sql=$conn->prepare("Insert Into trav2(country_name,Email,Source,Destination,Date,Time,NumPpl)
			...
			<div id="wrapper">
				...
				<nav id="menu">
					<ul class="links">
		                ...
		                <li class="active"> <a href="allbook.html">Packages</a> </li>
...
; 
              ...
              vertical-align:9px"/>
												...
												<div class="field half text-right">
													<ul class="actions">
														<li><button type="submit" name="submit" value="Send Request" class="primary" formaction="/temp1/action_page2.php">Submit </button></li>
													</ul>
												</div>
											</div>
										</form>
